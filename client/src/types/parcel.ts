...
export interface GridParcel {
  ...
  /** The risked decision figure: the measurement scaled by evidence coverage
   *  inside the parcel tier, unscaled outside it. Generated by the database;
   *  recomputed in the browser when the sliders re-weight. This is what the
   *  ranking, the list and the map shading use. */
  composite_score: number;
  /** The screening measurement, before any risking. Zones form on this — a
   *  cluster of high-scoring contiguous cells is a finding about the land,
   *  and diligence coverage is not a property of the land. Optional because
   *  demo/mock rows predate it; consumers fall back to `composite_score`. */
  composite_score_unrisked?: number;
